...
city_4_name = 'Mumbai'
city_4_population = 12488000
city_4_unemployment_rate = 8.5
...
# if and if elif clauses can use multiple conditions using logical operators AND / OR
if (city_4_population > city_3_population) & (city_3_population > city_1_population):
    result = city_4_name + ' is bigger than ' + city_3_name + ' and ' + city_1_name
elif (city_3_population > city_4_population) & (city_4_population > city_1_population):
    result = city_3_name + ' is bigger than ' + city_1_name + ' and ' + city_3_name
elif (city_1_population > city_4_population) & (city_4_population > city_3_population):
    result = city_1_name + ' is bigger than ' + city_3_name + ' and ' + city_1_name
else:
    result = 'We could not identify which city is bigger'
print(result)
...
if city_4_unemployment_rate > city_3_unemployment_rate:
    ...
    result = city_3_name + ' has a higher unemployment rate than ' + city_4_name
print(result)
